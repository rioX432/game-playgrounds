# Sample Backlog — three-playground
...
| 02 | Physics grab & throw (Rapier) | ✅ |
| 03 | Paint-on-mesh (CanvasTexture) | ✅ |
...
| 05 | Spatial-audio proximity falloff | F2, F3 | PositionalAudio + distance attenuation (proximity-voice stand-in) |
